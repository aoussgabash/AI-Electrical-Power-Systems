(() => {
  ...
  const initCourseNavigation = () => {
    ...
    style.textContent = `
      ...
      .course-action-related .course-action-icon{color:#facc15!important}.course-action-download .course-action-icon{color:#7dd3fc!important}
      ...
      .course-action-related{border-color:rgba(250,204,21,.38)!important}.course-action-download{border-color:rgba(56,189,248,.58)!important;background:linear-gradient(145deg,#0d527e,#0a304e)!important}
